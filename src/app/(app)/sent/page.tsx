...
export default function SentPage() {
  ...
  useEffect(() => {
    fetch('/api/sent')
      .then(r => r.json())
      .then((data: unknown) => { setMessages(data as SentItem[]); setLoading(false) })
      .catch(() => setLoading(false))
  }, [])

  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">Sent</h1>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {messages.map((msg, i) => (
                ...
                >
                  <td className="px-4 py-3 font-medium text-gray-900">{msg.to}</td>
